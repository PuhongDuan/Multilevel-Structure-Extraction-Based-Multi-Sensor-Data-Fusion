...
%         map=[0 0 255;255 100 0;0 255 134;150 70 150; 100 150 255;60 90 114;255 255 125;255 0 255;100 0 255;1 170 255;0 255 0;175 175 82;100 190 56;140 67 46;115 255 172;255 255 0];
      ...
      case 'houston'
          map=[0 180 0;0 120 0;0 140 70;0 70 0;170 120 10;0 184 189;120 0 0;218 218 249;120 120 120;207 173 129;230 200 160;88 88 88;184 177 96;0 240 0;203 17 54];
%          map=[0, 205, 0;  127, 255, 0;  46, 139, 87; 0, 139, 0;160, 82, 45;0, 255, 255;255, 255, 255;216, 191, 216; 255, 0, 0; 139, 0, 0;  0, 100, 255;255, 255, 0;238, 154, 0; 85, 26, 139;255, 127, 80; 255, 0,255];
...
%           map=[140 67 46;0 0 255;255 100 0;0 255 123;164 75 155;101 174 255;118 254 172; 60 91 112;255,255,0;255 255 125;255 0 255;100 0 255;0 172 254;0 255 0;171 175 80;101 193 60;100 150 30; 200 230 100; 250 100 0; 100 200 88];
        for i=1:w
          ...
          case 'berlin'
        map=[150 85 55;240 40 40;125 35 35;124 200 60; 230 230 80;230 145 50;100 200 210;240 120 90];
        for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
    ...
    case 'italy'
        map=[185,219,120;239,228,164;100,130,40;0,170,0;0,106,0;185,185,185];
        for i=1:w
            for j=1:h
                switch(label(i,j))
                    case(1)
